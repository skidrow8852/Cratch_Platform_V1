                      ...
                      <Menu isLazy >
                        <MenuButton >
                          ...
                          <MenuList ml={20} bg="#242627">
                              ...
                              <MenuItem onClick={logout} borderBottom="1px solid rgb(255,255,255,0.1)" fontSize="1.1rem"><Box pr={3} color="rgb(255,255,255,0.5)"><AiOutlineLogout /></Box>Logout</MenuItem>
                            </MenuList>
                    </Menu>
