...
import {Box , Center, Image, Tooltip,useToast} from '@chakra-ui/react';
      ...
      <Box >
                  <Center justifyContent="center" d="flex" flexDirection="column" alignContent="center" textAlign="center">
                      ...
                      <Link to="/">
                        ...
                        <Center  cursor="pointer" mt={120}  onClick={() => {setColorDarkMode(!colorDarkMode);toast({
                              title: `Light mode will be available soon`,
                              status: 'info',
                              isClosable: true,
                            })}} bg={colorDarkMode === true ? "#323435" : '#f4f2f2'} width="3.4rem" height="6rem" justifyContent="space-between" p={2} borderRadius="60px" d="flex" flexDirection="column"> 
                          { colorDarkMode === true ?   <>
